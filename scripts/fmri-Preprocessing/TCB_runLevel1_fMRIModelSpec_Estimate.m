...
% root_path = '/Volumes/TCB/spm-data/'; % testing local
...
% design_SOTS="TCB_Event_AllIntervPmod_RewPenRTacc_sots_allTcat"
...
matlabbatch{2}.spm.tools.rwls.fmri_rwls_spec.mthresh = 0.6; % Lowered from 0.8 to 0.6
...
% save matlablab
dir_batchsave = fullfile(root_path,['sub-',participant_id,'/',design_foldername,'/batch_job_sub-',participant_id,'_',design_foldername,'.mat']);
display(dir_batchsave)
save(dir_batchsave,'matlabbatch')
