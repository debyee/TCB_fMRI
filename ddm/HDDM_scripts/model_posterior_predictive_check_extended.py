...
# Extended reads in json file for variables
...
datafile = info['data']
ppcsample = info['ppcsample']

model_path = '../output/errors_automatic/' + valence + '/' + model_name + '/' + model_name
...
# model_path = '../output/errors_automatic/' + sys.argv[1] + '/' + sys.argv[1]
