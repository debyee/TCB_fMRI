...
design_SOTS="TCB_Event_CueInterval_RewPenHighLow_sots_allTcat"
...
for pid in "${participant_numbers[@]}"; do
    ...
    matlab-threaded -r "TCB_runLevel1_fMRIModelSpec_Estimate('${pid}','${root_path}','${design_foldername}','${design_SOTS}');exit;"
    ...
    matlab-threaded -r "TCB_runLevel1_contrast('${pid}','${root_path}','${design_foldername}');exit;"
