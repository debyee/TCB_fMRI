...
module load spm/spm12 #_7771
#module load conn/18b_runtime
...
participant_numbers=('2011' '2012' '2013' '2014' '2015' '2017' '2017' '2019' '2020' '2021' '2022' '2024')
...
for cid in "${!contrast[@]}"; do
    ...
    #matlab -r addpath '/gpfs/rt/7.2/opt/spm/spm12' "spm_jobman; exit"
    matlab -nodesktop -nosplash -r "TCB_runLevel2_group('${root_path}','${contrast_folder}','${design_foldername}','${contrast[$cid]}');exit;"
    #matlab -nodesktop -r addpath '/gpfs/rt/7.2/opt/spm/spm12' "TCB_runLevel2_group('${root_path}','${contrast_folder}','${design_foldername}','${contrast[$cid]}');exit;"
    #matlab -r addpath '/gpfs/rt/7.2/opt/spm/spm12' "TCB_runLevel2_group('${root_path}','${contrast_folder}','${design_foldername}','${contrast[$cid]}');exit;"
