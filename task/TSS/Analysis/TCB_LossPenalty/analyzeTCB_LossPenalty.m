...
files = dir('../../TCB_LossPenalty/Results/TSS_TCB_LossPenalty_2*mat');
fileNames = {files(:).name};

for x = 1:length(fileNames)
    file = ['../../TCB_LossPenalty/Results/', fileNames{x}];
     tmp = load(file);
     data.raw(x).p = tmp.p;
...
for x = 1:length(fileNames)
    %try
        ...
        % Stimulus properties
        if isempty(data.raw(x).p.stimuli) % s2030 is missing stimulis data
    ...
    %% CREATE ARRAYS FOR ALL TRIAL-BASED VARIABLES
        ...
        Rew2Pen1_error = find(contains(curSubData.BlockType,'Rew') & strcmp(curSubData.CueDisplayed,'Loss2_Pen1') & curSubData.RewardLevel == 1 & curSubData.PenaltyLevel == 1);
        curSubData.PenaltyLevel(Rew2Pen1_error) = 0;
        curSubData.TaskBugCorrected(Rew2Pen1_error) = 1;
%         Rew2Pen1_total = find(contains(curSubData.BlockType,'Rew') & strcmp(curSubData.CueDisplayed,'Loss2_Pen1') & curSubData.RewardLevel == 1);
%         Rew2Pen1_correct = find(contains(curSubData.BlockType,'Rew') & strcmp(curSubData.CueDisplayed,'Loss2_Pen1') & curSubData.RewardLevel == 1 & curSubData.PenaltyLevel == 0);
%         Rew2Pen1_error = find(contains(curSubData.BlockType,'Rew') & strcmp(curSubData.CueDisplayed,'Loss2_Pen1') & curSubData.RewardLevel == 1 & curSubData.PenaltyLevel == 1);
...
%         end
        ...
        Rew2Pen2_error = find(contains(curSubData.BlockType,'Rew') & strcmp(curSubData.CueDisplayed,'Loss2_Pen2') & curSubData.RewardLevel == 1 & curSubData.PenaltyLevel == 0);
        curSubData.PenaltyLevel(Rew2Pen2_error) = 1;
        curSubData.TaskBugCorrected(Rew2Pen2_error) = 1;
%         Rew2Pen2_total = find(contains(curSubData.BlockType,'Rew') & strcmp(curSubData.CueDisplayed,'Loss2_Pen2') & curSubData.RewardLevel == 1);
%         Rew2Pen2_correct = find(contains(curSubData.BlockType,'Rew') & strcmp(curSubData.CueDisplayed,'Loss2_Pen2') & curSubData.RewardLevel == 1 & curSubData.PenaltyLevel == 1);
%         Rew2Pen2_error = find(contains(curSubData.BlockType,'Rew') & strcmp(curSubData.CueDisplayed,'Loss2_Pen2') & curSubData.RewardLevel == 1 & curSubData.PenaltyLevel == 0);
...
%         end
        ...
        Rew1Pen1_error = find(contains(curSubData.BlockType,'Rew') & strcmp(curSubData.CueDisplayed,'Loss1_Pen1') & curSubData.RewardLevel == 0 & curSubData.PenaltyLevel == 1);
        curSubData.PenaltyLevel(Rew1Pen1_error) = 0;
        curSubData.TaskBugCorrected(Rew1Pen1_error) = 1;
%         Rew1Pen1_total = find(contains(curSubData.BlockType,'Rew') & strcmp(curSubData.CueDisplayed,'Loss1_Pen1') & curSubData.RewardLevel == 0);
%         Rew1Pen1_correct = find(contains(curSubData.BlockType,'Rew') & strcmp(curSubData.CueDisplayed,'Loss1_Pen1') & curSubData.RewardLevel == 0 & curSubData.PenaltyLevel == 0);
%         Rew1Pen1_error = find(contains(curSubData.BlockType,'Rew') & strcmp(curSubData.CueDisplayed,'Loss1_Pen1') & curSubData.RewardLevel == 0 & curSubData.PenaltyLevel == 1);
...
%         end
        ...
        Rew1Pen2_error = find(contains(curSubData.BlockType,'Rew') & strcmp(curSubData.CueDisplayed,'Loss1_Pen2') & curSubData.RewardLevel == 0 & curSubData.PenaltyLevel == 0);
        curSubData.PenaltyLevel(Rew1Pen2_error) = 1;
        curSubData.TaskBugCorrected(Rew1Pen2_error) = 1;
%         Rew1Pen2_total = find(contains(curSubData.BlockType,'Rew') & strcmp(curSubData.CueDisplayed,'Loss1_Pen2') & curSubData.RewardLevel == 0);
%         Rew1Pen2_correct = find(contains(curSubData.BlockType,'Rew') & strcmp(curSubData.CueDisplayed,'Loss1_Pen2') & curSubData.RewardLevel == 0 & curSubData.PenaltyLevel == 1);
%         Rew1Pen2_error = find(contains(curSubData.BlockType,'Rew') & strcmp(curSubData.CueDisplayed,'Loss1_Pen2') & curSubData.RewardLevel == 0 & curSubData.PenaltyLevel == 0);
...
%         end               
        ...
        curSubDataInt = table(curIntSubID',curIntRewLvl',curIntPenLvl',curIntCueDisplay',curIntTotal',curIntLength',curIntLengthSecs',curIntLengthSecsNoISI',...
            curIntTaskBugCorrected',curIntRewLvl',curIntPenLvl');
        curSubDataInt_header = {'SubID','RewardLevel','PenaltyLevel','CueDisplayed','Interval','IntervalLength_Ideal','IntervalLength_Actual','IntervalLengthNoISI_Actual',...
            'TaskBugCorrected','RewardLevelTaskCode','PenaltyLevelTaskCode'};
        ...
        % Rew2Pen1 (Loss2Pen1) correction
        Rew2Pen1_error = find(strcmp(curSubDataInt.CueDisplayed,'Loss2_Pen1') & curSubDataInt.RewardLevel == 1 & curSubDataInt.PenaltyLevel == 1);
        curSubDataInt.PenaltyLevel(Rew2Pen1_error) = 0;
        curSubDataInt.TaskBugCorrected(Rew2Pen1_error) = 1;
        
        % Rew2Pen2 (Loss2Pen2) correction
        Rew2Pen2_error = find(strcmp(curSubDataInt.CueDisplayed,'Loss2_Pen2') & curSubDataInt.RewardLevel == 1 & curSubDataInt.PenaltyLevel == 0);
        curSubDataInt.PenaltyLevel(Rew2Pen2_error) = 1;
        curSubDataInt.TaskBugCorrected(Rew2Pen2_error) = 1;
        
        % Rew1Pen2 (Loss1Pen2) correction
        Rew1Pen1_error = find(strcmp(curSubDataInt.CueDisplayed,'Loss1_Pen1') & curSubDataInt.RewardLevel == 0 & curSubDataInt.PenaltyLevel == 1);
        curSubDataInt.PenaltyLevel(Rew1Pen1_error) = 0;
        curSubDataInt.TaskBugCorrected(Rew1Pen1_error) = 1;
        
        % Rew1Pen1 (Loss1Pen1) correction
        Rew1Pen2_error = find(strcmp(curSubDataInt.CueDisplayed,'Loss1_Pen2') & curSubDataInt.RewardLevel == 0 & curSubDataInt.PenaltyLevel == 0);
...
pathToSave_Trial = strcat(pwd,'/DataFormatted/data_fMRI-TCB_LossPenalty_Trial.csv');
writetable(subDataAll_Trial,pathToSave_Trial);
pathToSave_Interval = strcat(pwd,'/DataFormatted/data_fMRI-TCB_LossPenalty_Interval.csv');
