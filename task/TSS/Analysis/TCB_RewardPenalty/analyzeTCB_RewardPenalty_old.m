...
for x = 1:length(fileNames)
    ...
    %% CREATE ARRAYS FOR ALL TRIAL-BASED VARIABLES
        ...
        for block = 1:numBlocks
           ...
           curBlockType(curIntNum>=blockInt(block) & curIntNum<(blockInt(block)+numIntervalsPerBlock)) = {data.raw(1).p.blockOrder{block}};
        end
        ...
        for int = 1:numIntervalsTotal
            ...
            curIntLengthNoISI_Trial(ix_start:ix_end) = curIntLength(int) - ((trialsCompletedPerInterval(int) - 1) * data.raw(x).p.timing.isi);
            curTrialsCompletedPerInterval_Trial(ix_start:ix_end) = trialsCompletedPerInterval(int) - 1;
            ...
            curIntLengthSecsNoISI_Trial(ix_start:ix_end) = thisIntLengthSecs - ((trialsCompletedPerInterval(int) - 1) * data.raw(x).p.timing.isi);
            
            % interval variables
            curIntLengthSecs(int) = thisIntLengthSecs;
            curIntLengthSecsNoISI(int) = thisIntLengthSecs - ((trialsCompletedPerInterval(int) - 1) * data.raw(x).p.timing.isi);
        ...
        Rew2Pen1_total = find(strcmp(curSubData.BlockType,'highRew') & strcmp(curSubData.CueDisplayed,'Rew2_Pen1') & curSubData.RewardLevel == 1);
        Rew2Pen1_correct = find(strcmp(curSubData.BlockType,'highRew') & strcmp(curSubData.CueDisplayed,'Rew2_Pen1') & curSubData.RewardLevel == 1 & curSubData.PenaltyLevel == 0);
        Rew2Pen1_error = find(strcmp(curSubData.BlockType,'highRew') & strcmp(curSubData.CueDisplayed,'Rew2_Pen1') & curSubData.RewardLevel == 1 & curSubData.PenaltyLevel == 1);
        ...
        Rew2Pen2_total = find(strcmp(curSubData.BlockType,'highRew') & strcmp(curSubData.CueDisplayed,'Rew2_Pen2') & curSubData.RewardLevel == 1);
        Rew2Pen2_correct = find(strcmp(curSubData.BlockType,'highRew') & strcmp(curSubData.CueDisplayed,'Rew2_Pen2') & curSubData.RewardLevel == 1 & curSubData.PenaltyLevel == 1);
        Rew2Pen2_error = find(strcmp(curSubData.BlockType,'highRew') & strcmp(curSubData.CueDisplayed,'Rew2_Pen2') & curSubData.RewardLevel == 1 & curSubData.PenaltyLevel == 0);
        ...
        Rew1Pen1_total = find(strcmp(curSubData.BlockType,'lowRew') & strcmp(curSubData.CueDisplayed,'Rew1_Pen1') & curSubData.RewardLevel == 0);
        Rew1Pen1_correct = find(strcmp(curSubData.BlockType,'lowRew') & strcmp(curSubData.CueDisplayed,'Rew1_Pen1') & curSubData.RewardLevel == 0 & curSubData.PenaltyLevel == 0);
        Rew1Pen1_error = find(strcmp(curSubData.BlockType,'lowRew') & strcmp(curSubData.CueDisplayed,'Rew1_Pen1') & curSubData.RewardLevel == 0 & curSubData.PenaltyLevel == 1);
        ...
        Rew1Pen2_total = find(strcmp(curSubData.BlockType,'lowRew') & strcmp(curSubData.CueDisplayed,'Rew1_Pen2') & curSubData.RewardLevel == 0);
        Rew1Pen2_correct = find(strcmp(curSubData.BlockType,'lowRew') & strcmp(curSubData.CueDisplayed,'Rew1_Pen2') & curSubData.RewardLevel == 0 & curSubData.PenaltyLevel == 1);
        Rew1Pen2_error = find(strcmp(curSubData.BlockType,'lowRew') & strcmp(curSubData.CueDisplayed,'Rew1_Pen2') & curSubData.RewardLevel == 0 & curSubData.PenaltyLevel == 0);
