function TCB_runLevel2_group(root_path, dir_contrast, design_foldername, contrast_name)
    ...
    % dir_contrast=['/gpfs/data/ashenhav/mri-data/TCB/spm-data/groupstats/',design_foldername,'/',contrast_name];
    ...
    allRuns = dir(fullfile(root_path,'groupstats',design_foldername,contrast_name,'/sub*_con_*.nii'));
    allRuns = {allRuns(:).name}';
    allRuns = strcat(root_path,'groupstats/',design_foldername,'/',contrast_name,'/',allRuns,',1');
    ...
    %matlabbatch{1}.spm.stats.factorial_design.dir = { '/gpfs/data/ashenhav/mri-data/TCB/spm-data/groupstats/design_CueIntFb12_EventEpoch_rwls/C1_Cue_TaskvsBaseline'};
