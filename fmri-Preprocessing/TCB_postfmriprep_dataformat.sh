...
#SBATCH -J TCB-postfmriprep
#SBATCH --output logs/TCB-postfmriprep-dataformat-%J.txt

# Directories
bids_dir=/gpfs/data/ashenhav/mri-data/TCB/shenhav/study-201226/bids/derivatives/fmriprep-20.2.6-nofs/fmriprep/
spm_dir=/gpfs/data/ashenhav/mri-data/TCB/spm-data/


# Participant, session, and run labels
participant_labels=("tcb2047")  
participant_numbers=(2047 2112 2127)
